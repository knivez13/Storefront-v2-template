...
contract MynthchainMarket is ReentrancyGuard {
    ...
    /* number of items minting, number of transactions, tokens that have not been sold
     ...
     uint256 listingPrice = 0.002 ether; // <------ IMportant!!!! - We are using Ethereum so this Listing Price goes for all NFT's minted and listed on the platform in regards to listing floor price
